...
window.CONFIG = {
  ...
  templates: { //You can add static templates here
    'default': '<div class="chat-set"><div class="chat-m-icon"><i class="bi bi-envelope-open-fill"></i></div><div class="chat-message"><div class="chat-message-body"><strong>{0}:</strong> {1}</div></div></div>',
    'defaultAlt': '{0}',
    'print': '<pre>{0}</pre>',
